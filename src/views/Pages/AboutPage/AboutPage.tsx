            ...
            <div className={styles.content}>
                <div className={styles.content_desktop}>
                    <div className={styles.content_article}>
                        ...
                        <p className={styles.contente_p} style={{marginBottom: "20px"}}>В практике вам поможет персональный Dinoteacher. <React.Fragment><br /></React.Fragment>🦖 Он проверит вашу письменную речь, подправит ошибки и подскажет, как лучше. Все, что вас отделяет от успеха<React.Fragment><br /></React.Fragment> — это нажать на кнопку "Начать практику"! 🚀</p>
                        {token ? (
                            <Link to="/quest">
